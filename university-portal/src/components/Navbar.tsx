import { Bell, LogOut, Search, Sun, Moon, X } from "lucide-react";
      ...
      <div className="flex items-center gap-2">
        ...
        <button onClick={() => setDarkMode(d => !d)}
          className={cn("grid h-9 w-9 place-items-center rounded-lg border transition",
            darkMode ? "border-white/5 bg-white/5 text-amber-400 hover:bg-white/10" : "border-slate-200 bg-slate-100 text-slate-600 hover:bg-slate-200")}>
